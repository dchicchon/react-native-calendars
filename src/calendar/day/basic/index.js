...
const BasicDay = (props) => {
    const { theme, date, onPress, 
    // onLongPress,
    markingType, marking, state, 
    ...
    const renderMarking = () => {
        const {} = _marking;
        return (<Marking type={markingType} theme={theme} 
    ...
    const renderContainer = () => {
        ...
        activeOpacity={activeOpacity} onPress={_onPress} 
