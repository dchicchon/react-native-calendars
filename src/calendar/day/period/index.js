...
const PeriodDay = (props) => {
    ...
    return (<Component testID={testID} onPress={_onPress} accessible accessibilityRole={marking?.disableTouchEvent ? undefined : 'button'} accessibilityLabel={accessibilityLabel}>
