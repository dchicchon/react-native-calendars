...
const Week = (props) => {
    ...
    onDayPress, 
    // onDayLongPress,
    style: propsStyle, numberOfDays = 1, timelineLeftInset, testID, } = props;
    ...
    const renderDay = (day, id) => {
        ...
        <Day {...dayProps} testID={`${testID}.day_${dayString}`} date={dayString} state={getState(day, currXdate, props, disableDaySelection)} onPress={onDayPress}/>
      </View>);
    };
    const renderWeek = () => {
